...
def clean_list(txt):
    stoplist = set('for a an of the and to in or by not as so this that their them with but with at on he his she her have had has him be is was were are it i will you they me do did your am there would when what where could my if'.split())
...
if __name__=="__main__":
    ...
    lda = gensim.models.ldamodel.LdaModel(corpus=corpus, \
                                          id2word=dictionary,\
       num_topics=10, update_every=1, passes=100)
