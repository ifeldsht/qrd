...
\marginnote{\textbf{\small You need to learn basic operations and collections in Python -- lists, dictionaries}}
Tree1 = (Left stair,[])
...
\marginnote{\textbf{\small You need to learn about functions, loops, and conditional statements in Python}}
